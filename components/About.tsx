        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
                <motion.div 
                  ...
                  transition={{ type: "spring", stiffness: 400, damping: 20 }}
                  className="bg-white/80 backdrop-blur-sm p-8 rounded-[20px] shadow-sm hover:shadow-xl border border-slate-200 relative overflow-hidden group h-full"
                >
                    <div className="absolute top-0 right-0 w-32 h-32 bg-blue-100 rounded-bl-full -mr-8 -mt-8 transition-transform duration-500 group-hover:scale-110"></div>
            ...
            >
                <motion.div
                  ...
                  className="bg-white/80 backdrop-blur-sm p-8 rounded-[20px] shadow-sm hover:shadow-xl border border-slate-200 relative overflow-hidden group h-full"
                >
                    <div className="absolute top-0 right-0 w-32 h-32 bg-sky-100 rounded-bl-full -mr-8 -mt-8 transition-transform duration-500 group-hover:scale-110"></div>
            ...
            >
                <motion.div
                  ...
                  className="bg-white/80 backdrop-blur-sm p-8 rounded-[20px] shadow-sm hover:shadow-xl border border-slate-200 relative overflow-hidden group h-full"
                >
                    <div className="absolute top-0 right-0 w-32 h-32 bg-slate-200 rounded-bl-full -mr-8 -mt-8 transition-transform duration-500 group-hover:scale-110"></div>
