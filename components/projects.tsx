        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {PROJECTS.map((project, index) => (
            <motion.div 
              ...
              className="bg-white rounded-[16px] overflow-hidden shadow-sm border border-slate-200 hover:shadow-xl hover:border-theme-primary/30 flex flex-col h-full group transition-all duration-300"
            >
              {/* Image */}
